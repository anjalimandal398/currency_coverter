...
const converterContainerElement = document.querySelector(
  ".converter-container"
);
  ...
  try {
    ...
    if (typeof conversionRate === "undefined") {
      resultElement.textContent =
        "Exchange rate is not available for selected countries!!!";
    ...
    converterContainerElement.innerHTML = `
    <h1>Error while fetching exchange rates!!!</h1>
  `;
